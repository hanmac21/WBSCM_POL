		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				<a href="#" class="sidebar-toggle" data-toggle="offcanvas"
					role="button"> <%=session_cu_sangho%><span class="sr-only">Toggle
						navigation</span>
				</a>
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												...
												<th style="text-align: center;">예상제고</th>
											</tr>
										</thead>
										<tbody>
											<c:choose>
												<c:when test="${ board.size() > 0 }">
													<c:forEach var="vo" items="${ board }" varStatus="status">
														...
														<tr>
															...
															<td>${vo.day10}</td>
															<td>${vo.day11}</td>
															<td>${vo.day1+vo.day2+vo.day3+vo.day4+vo.day5+vo.day6+vo.day7+vo.day8+vo.day9+vo.day10+vo.day11}</td>
															<td>${vo.plan_qty+vo.stock_qty+vo.safetystock+vo.day1+vo.day2+vo.day3+vo.day4+vo.day5+vo.day6+vo.day7+vo.day8+vo.day9+vo.day10+vo.day11}</td>
														</tr>
							...
							<div class="modal-body">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">현재 <br>포인트
										</label>
										<div class="input-group input-group-sm"
											style="padding-left: 14px; padding-right: 14px;">
											<input type="text" class="form-control" placeholder=""
												value="" id="p_tatal_point" readonly="readonly">
										</div>

									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">증감<br>포인트
										</label>
										<div class="input-group input-group-sm"
											style="padding-left: 14px; padding-right: 14px;">
											<input type="text" class="form-control" placeholder=""
