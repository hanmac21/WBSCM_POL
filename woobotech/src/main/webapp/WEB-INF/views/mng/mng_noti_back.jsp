				...
				<div class="row" style="width: 100%; margin-bottom: 20px;">
					<!-- 공통 검색 조건 -->
						...
						<div class="col-xs-12" style="padding-right: 0px;">
							<span> 제목 : </span> <input type="text" id="p_title"		name="p_title" style="margin-left: 10px; width: 100px"	value="" />
							<span> 내용 : </span> <input type="text" id="s_contents"		name="s_contents" style="margin-left: 10px; width: 200px"	value="" />
							<input
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												...
												<th style="font-size: 18px" width="20%">등록자</th>
												...
												<c:when test="${ board.size() > 0 }">
													<c:forEach var="vo" items="${ board }">
														<tr>
															...
															<td style="font-size: 18px">우보테크</td>
															<td style="font-size: 18px"> ${ vo.reg_date}</td>
															<td  style="font-size: 18px"><input type="button" class="btn btn-warning" onclick="fnNotiDt(${vo.brd_no})" value="상세"/></td>
