				...
				<div class="row" style="width: 100%; margin-bottom: 20px;">
					...
					<div class="row" style="width: 100%; margin-bottom: 20px;">
						...
						<div class="col-xs-12" style="padding-right: 0px;">
							<span>등록일자</span> <input type="text" id="startdate"
								name="startdate" style="margin-left: 10px;"> <span>~</span>
							<input type="text" id="enddate" name="enddate"
								style="margin-right: 20px;"> <span> 제목 : </span> <input type="text" id="p_title"	name="p_title" style="margin-left: 10px; width: 100px"	value="" />
							<input
							...
							<div class="box">
								...
								<div class="box-body">
									...
									<table id="tablebody" width="100%"
										...
										<thead>
											<tr>
												<th style="font-size: 18px" width="40%">제목</th>
												<th style="font-size: 18px" width="20%">협력사</th>
												<th style="font-size: 18px" width="20%">등록일자</th>
												<th style="font-size: 18px" width="20%">보기</th>
											...
											<c:choose>
												<c:when test="${ board.size() > 0 }">
													<c:forEach var="vo" items="${ board }">
														<tr>
														    <td style="font-size: 18px">${ vo.title}</td>
															<td style="font-size: 18px">${ vo.cu_sangho}</td>
															<td style="font-size: 18px">${ vo.reg_date}</td>
															<td style="font-size: 18px"><input type="button" class="btn btn-warning" onclick="fnCwNotiDt(${vo.brd_no})" value="상세"/></td>
