	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<span style="float: left; font-size: 30px;"><!-- 생산계획관리 -->Production Plan</span> <span
			...
			<section class="content">
				...
				<div class="row" style="width: 100%; margin-bottom: 5px; padding-bottom: 5px;">
					...
					<div class="col-xs-12" style="padding-right: 0px;">
						...
						<span><!-- 생산계획일자 -->Production plan date : </span> &nbsp;
						...
						<input type="text" id="startdate" name="startdate" value="${startdate }" style="width:125px; margin-right: 10px;"" readonly autocomplete="off"/>	
							...
							<%--  <span>
							Factory : </span> &nbsp;<select id="branch" name="branch"
						...
						<input type="button" class="btn btn-success" 
							onclick="showExcel()" value="Save excel" style="margin-left: 50px;" />

						<div id="page" style="float: right;">
							<span>Per page</span> <select id="itemCountPerPage"
